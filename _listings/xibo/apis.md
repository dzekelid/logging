...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/logging/master/_listings/xibo/apis.md
...
- name: 'Xibo API - Action: Clear Stats and Logs'
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/logging/master/_listings/xibo/displaygroupdisplaygroupidactionclearstatsandlogs-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/logging/master/_listings/xibo/displaygroupdisplaygroupidactionclearstatsandlogs-post-openapi.md
- name: 'Xibo API - Action: Clear Stats and Logs'
  x-api-slug: displaygroupdisplaygroupidactionclearstatsandlogs-post
  description: Clear all stats and logs on this Group
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/xibo-digital-signage-logo.jpeg
